...
class Course(models.Model):
    ...
    examples_ar = models.TextField(blank=True, null=True)
    examples_fr = models.TextField(blank=True, null=True)
    astuces = models.TextField(blank=True, null=True)
    astuces_ar = models.TextField(blank=True, null=True)
    astuces_fr = models.TextField(blank=True, null=True)
