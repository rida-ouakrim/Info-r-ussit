...
from .views import RegisterView, MeView, LicenseKeyListView, CandidateDashboardView, AdminDashboardView, UpdateAllowedGenerationsView, SendVerificationCodeView, TrackStudyTimeView
